 ...
 * second copy from drifting. `../../package.json` resolves to the same file
 * in both layouts this module runs from: src/cli/ under tsx and vitest,
 * dist/cli/ in the published tarball (npm always ships package.json
 * alongside `files`).
 */
