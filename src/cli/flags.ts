...
export const sharedFlags = {
  ...
  maxWorkers: {
    kind: "parsed",
    parse: parseInteger,
    brief: "cap on planned claims (default 3)",
    placeholder: "n",
    optional: true,
  },
  maxOpenPrs: {
    kind: "parsed",
    parse: parseInteger,
    brief: "open agent PRs that pause dispatch (default 5)",
    placeholder: "n",
    optional: true,
  },
  pollSeconds: {
    kind: "parsed",
    parse: parseInteger,
    brief: "seconds between run's ticks (default 30)",
    placeholder: "n",
    optional: true,
  },
  model: {
    kind: "parsed",
    parse: String,
    brief: "model Workers run on (default sonnet)",
    placeholder: "name",
    optional: true,
  },
  retryModel: {
    kind: "parsed",
    parse: String,
    brief: "model second attempts run on (default opus)",
    placeholder: "name",
    optional: true,
  },
  verbose: {
